      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              org.apache.skywalking.apm.network.language.agent.v3.SegmentReference m =
                  input.readMessage(
                      org.apache.skywalking.apm.network.language.agent.v3.SegmentReference.parser(),
                      extensionRegistry);
              if (refsBuilder_ == null) {
                ensureRefsIsMutable();
                refs_.add(m);
            ...
            case 106: {
              org.apache.skywalking.apm.network.language.agent.v3.Log m =
                  input.readMessage(
                      org.apache.skywalking.apm.network.language.agent.v3.Log.parser(),
                      extensionRegistry);
              if (logsBuilder_ == null) {
                ensureLogsIsMutable();
                logs_.add(m);
