        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadata m =
                  input.readMessage(
                      org.apache.skywalking.apm.network.ebpf.profiling.v3.EBPFProfilingStackMetadata.parser(),
                      extensionRegistry);
              if (stacksBuilder_ == null) {
                ensureStacksIsMutable();
                stacks_.add(m);
              } else {
                stacksBuilder_.addMessage(m);
              }
              break;
            } // case 10
            case 16: {
